  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="container relative z-10 px-6 py-16 text-center">
        ...
        >
          Get More Russell Group University Offers,<br />Year On Year
        </motion.h1>
        ...
        >
          ...
          , our data-driven analysis shows how you compare to similar schools - and whether you are pulling ahead or falling behind.
        </motion.p>
      </div>
